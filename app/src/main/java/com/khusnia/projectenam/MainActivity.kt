...
class MainActivity : AppCompatActivity() {
    ...
    private fun phoneItemClicked(phoneItem : PhoneData) {
        ...
        showDetailActivityIntent.putExtra(Intent.EXTRA_TEMPLATE, phoneItem.contactName.toString())
    ...
    private fun createPhoneData() : List<PhoneData> {
        ...
        partList.add(PhoneData(897654, "Delta"))
        partList.add(PhoneData(754309, "Echo"))
        return partList
    }
}